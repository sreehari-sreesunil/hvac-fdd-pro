"""Auth dependency for copilot-service - mirrors every other service's
pattern exactly: resolve asset -> facility -> org membership via
asset-service, verify the JWT locally via the shared common.security
module."""
